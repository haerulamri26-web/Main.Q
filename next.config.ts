...
const nextConfig: NextConfig = {
  async headers() {
    const cspHeader = [
      ...
      "connect-src 'self' *.firebasedatabase.app wss://*.firebaseio.com https://www.google-analytics.com https://firestore.googleapis.com https://identitytoolkit.googleapis.com",
