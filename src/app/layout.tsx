...
export const metadata: Metadata = {
  title: 'MAIN Q: Platform Game Edukasi',
  description: 'MAIN Q adalah platform untuk menemukan, bermain, dan berbagi game edukasi interaktif yang dibuat oleh guru untuk siswa.',
};

const MainQLogo = ({ className }: { className?: string }) => (
    <div className={cn("flex items-center gap-2.5 text-xl font-bold font-headline", className)}>
        <div className="flex items-center justify-center h-8 w-8 rounded-full bg-primary text-primary-foreground">
            <svg viewBox="0 0 24 24" fill="currentColor" className="h-5 w-5 -mr-0.5">
                <path d="M8 5v14l11-7z" />
            </svg>
        </div>
        <span className="text-2xl tracking-tighter">MAIN Q</span>
    </div>
);
