...
import { Play, Loader2, Search, Eye, User, ChevronLeft, ChevronRight } from 'lucide-react';
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <section className="text-center mb-12 animate-in fade-in-0 slide-in-from-top-4 duration-500">
        <h1 className="text-4xl md:text-5xl font-bold font-headline mb-4 text-primary">Jelajahi Dunia Belajar yang Menyenangkan</h1>
        <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
          Temukan, mainkan, dan bagikan game edukasi interaktif. Belajar jadi lebih seru bersama MAIN Q.
        </p>
      </section>
      ...
      <section className="animate-in fade-in-0 slide-in-from-top-12 duration-500 delay-200">
        <h2 className="text-2xl font-bold mb-6 font-headline">Semua Game</h2>
        {isLoading && (
