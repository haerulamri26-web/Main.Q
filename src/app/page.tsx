  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <section className="text-center mb-12 animate-in fade-in-0 slide-in-from-top-4 duration-500">
        <h1 className="text-4xl md:text-5xl font-bold font-headline mb-4 text-primary">Platform #1 untuk Game Edukasi Interaktif</h1>
        <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
          Jelajahi ribuan game edukasi HTML5 buatan guru dari seluruh Indonesia, atau buat game Anda sendiri dengan mudah.
        </p>
        <div className="mt-8">
